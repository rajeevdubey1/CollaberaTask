  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Padding( // showing product original image
            ...
            Row(
              ...
              children: [
                Padding( // showing product name
                  padding: const EdgeInsets.only(left: 15),
                  child: Text(product.name, style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold,),),
                ),
                Padding( // showing product price
                  padding: const EdgeInsets.only(right: 15),
                  child: Text('\$${product.price}', style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w400, color: Colors.deepPurple),),
                ),
              ],
            ),
            const SizedBox(height: 20,),
            const Padding( // showing product description with dummy data
      ...
      bottomNavigationBar: InkWell(
              ...
              child: Container( // adding Add to Cart button
